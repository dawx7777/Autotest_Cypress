describe('Test of GetAll UserProject module', function(){
    ...
    it('Get All Task  without auth user',() => {
        ...
        cy.request({
            ...
            method: 'GET',
            url: 'https://localhost:44338/api/UserProject/GetAll',
    ...
    it('Get All Task with auth admin',() => {
        ...
        cy.request({
            ...
            method: 'GET',
            url: 'https://localhost:44338/api/UserProject/GetAll?id=2',
            failOnStatusCode: false,
            headers:{
